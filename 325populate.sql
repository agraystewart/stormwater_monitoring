...
/* Sources considered during the creation of data:

   Environmental Protection Agency, United States. "Analytical Methods Approved 
   for Drinking Water Compliance - Monitoring of Inorganic Contaminants and 
   Other Inorganic Constituents." EPA, https://nepis.epa.gov/Exe/ZyPDF.cgi?
   Dockey=P100WD2D.txt. Accessed December 2021.

   Environmental Protection Agency, United States. "Analytical Methods Approved 
   for Drinking Water Compliance - Monitoring of Organic Contaminants." EPA,
   https://nepis.epa.gov/Exe/ZyPDF.cgi?Dockey=P100WD47.txt. Accessed December
   2021.

   Environmental Protection Agency, United States. "Analytical Methods 
   Recommended for Drinking Water Compliance - Monitoring of Secondary 
   Contaminants." EPA, https://nepis.epa.gov/Exe/ZyPDF.cgi?Dockey=P100WD5Z.txt.
   Accessed December 2021.

   Environmental Protection Agency, United States. "Industrial Stormwater
   Monitoring and Sampling Guide." EPA, March 2009, https://www3.epa.gov/npdes/
   pubs/msgp_monitoring_guide.pdf. Accessed December 2021.

   Environmental Protection Agency, United States. "Method 180.1: Determination 
   of Turbidity by Nephelometry." EPA, https://www.epa.gov/sites/default/files/
   2015-08/documents/method_180-1_1993.pdf. Accessed December 2021. 

   Environmental Protection Agency, United States. "Total Suspended Solids (TSS)
   EPA Method 160.2." EPA, https://19january2017snapshot.epa.gov/sites/
   production/files/2015-06/documents/160_2.pdf. Accessed December 2021.

   Environmental Protection Agency, United States. "Quick Guide To Drinking 
   Water Sample Collection." EPA, September 2016, https://www.epa.gov/sites/
   default/files/2015-11/documents/drinking_water_sample_collection.pdf. 
   Accessed December 2021.

   Eurofins TestAmerica. "Analytical Report - KAG West: 580-91629-1." Department
   of Ecology, State of Washington, 14 January 2020, https://apps.ecology.wa.gov
   /paris/DownloadDocument.aspx?id=313954. Accessed December 2021.

   "Estimation of Green-Ampt Infiltration Parameters." Know Your H2O, https://
   files.knowyourh2o.com/water-library/Stormwater/greenamp.pdf. Accessed 
   November 2021.

   "Hydrologic Soil Groups." Purdue University, https://www.epa.gov/sites/
   default/files/2015-11/documents/drinking_water_sample_collection.pdf. 
   Accessed November 2021.

   TestAmerica Laboratories, Inc. "Analyitical Report - SSFL Group 3 - NASA."
   Santa Susana Field Laboratory - Environmental Investigation and Cleanup, 1 
   January, 2007, https://www.dtsc-ssfl.com/files/lib_rcra_soils/group3/
   historicaldocs/PDF_Files/HDMSE00056100.pdf. Accessed November 2021.

   TestAmerica Laboratories, Inc. "Analytical Report - West Lake Landfill: 
   160-3068-1." Environmental Protection Agency, 2 August 2013,
   https://archive.epa.gov/region07/cleanup/west_lake_landfill/web/pdf/append-b-
   2-july2013-testamerica-jobid-160-3068-1.pdf. Accessed December 2021.

   TestAmerica Laboratories, Inc. "Analytical Report - West Lake Landfill: 
   160-3079-1." Environmental Protection Agency, 7 August 2013,
   https://archive.epa.gov/region07/cleanup/west_lake_landfill/web/pdf/append-b-
   2-july2013-testamerica-jobid-160-3079-1.pdf. Accessed December 2021.
   
*/

delete from Soil_Area;

delete from Soil_Type;

delete from Data_Flag;

delete from Concentration;

delete from Stormwater_Sample;

delete from Sample;

delete from BMP_Sampling_Location;

delete from Sampling_Location;

delete from Maintenance;

delete from Stormwater_BMP;
...
insert into Storm
values
('2020-01',to_date('09-15-2019 05:10', 'mm-dd-yyyy hh24:mi'),
   to_date('09-16-2019 03:30', 'mm-dd-yyyy hh24:mi'),1.2);

insert into Storm
values
('2020-02',to_date('11-03-2019 13:00','mm-dd-yyyy hh24:mi'),
   to_date('11-04-2019 22:40','mm-dd-yyyy hh24:mi'),0.9);

insert into Storm
values
('2020-03',to_date('02-05-2020 05:00','mm-dd-yyyy hh24:mi'),
   to_date('02-05-2020 23:00','mm-dd-yyyy hh24:mi'),0.8);

insert into Storm
values
('2020-04',to_date('03-10-2020 02:40','mm-dd-yyyy hh24:mi'),
   to_date('03-11-2020 03:00','mm-dd-yyyy hh24:mi'),0.9);

insert into Storm
values
('2021-01',to_date('11-17-2020 16:50','mm-dd-yyyy hh24:mi'),
   to_date('11-18-2020 15:20','mm-dd-yyyy hh24:mi'),1.4);

insert into Storm
values
('2021-02',to_date('12-20-2020 10:00','mm-dd-yyyy hh24:mi'),
   to_date('12-21-2020 05:00','mm-dd-yyyy hh24:mi'),0.8);

insert into Storm
values
('2021-03',to_date('01-26-2021 08:20','mm-dd-yyyy hh24:mi'),
   to_date('01-26-2021 23:50','mm-dd-yyyy hh24:mi'),0.7);

insert into Storm
values
('2021-04',to_date('02-08-2021 11:40','mm-dd-yyyy hh24:mi'),
   to_date('02-09-2021 15:20','mm-dd-yyyy hh24:mi'),1.2);

insert into Storm
values
('2022-01',to_date('09-19-2021 07:30','mm-dd-yyyy hh24:mi'),
   to_date('09-20-2021 06:20','mm-dd-yyyy hh24:mi'),1);

insert into Storm
values
('2022-02',to_date('11-14-2021 14:50','mm-dd-yyyy hh24:mi'),
   to_date('11-16-2021 04:00','mm-dd-yyyy hh24:mi'),1.7);

insert into Storm
values
('2022-03',to_date('11-25-2021 18:00','mm-dd-yyyy hh24:mi'),
   to_date('11-26-2021 21:40','mm-dd-yyyy hh24:mi'),1.3);
...
values
('North Tributary Infiltration Basin','Infiltration Basin',40.39535794,
   -124.0146067,to_date('07-18-2016','mm-dd-yyyy hh24:mi'));

insert into Stormwater_BMP
values
('Valley Road Infiltration Trench','Infiltration Trench',40.38850721,
   -124.0254441,to_date('08-17-2017','mm-dd-yyyy hh24:mi'));

insert into Stormwater_BMP
values
('South Vegetated Swale','Vegetated Swale',40.38495766,
   -124.0341597,to_date('08-20-2017','mm-dd-yyyy hh24:mi'));

insert into Stormwater_BMP
values
('West Tributary Bioretention Basin','Bioretention Basin',40.39274388,
   -124.0393489,to_date('06-25-2018','mm-dd-yyyy hh24:mi'));

insert into Stormwater_BMP
values
('Valley Road Bioretention Basin','Bioretention Basin',40.38968556,
   -124.0228042,to_date('08-18-2018','mm-dd-yyyy hh24:mi'));

insert into Stormwater_BMP
values
('East Tributary Wetland','Artificial Wetland',40.39012193,
   -124.0128554,to_date('07-20-2020','mm-dd-yyyy hh24:mi'));

insert into Stormwater_BMP
values
('Quad Road Infiltration Basin','Infiltration Basin',40.39377765,
   -124.0301578,to_date('06-05-2021','mm-dd-yyyy hh24:mi'));
...
insert into Sampling_Location(samp_loc_name,samp_loc_type,samp_loc_lat,
   samp_loc_long)
values
...
insert into Sample
values
('2020-01','St20-01_blank','Blank',
   to_date('09-15-2019 09:50','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-01','St20-01_BMP_NTIB_US','Stormwater',
   to_date('09-15-2019 08:10','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-01','St20-01_BMP_NTIB_US_dup','Stormwater',
   to_date('09-15-2019 08:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-01','St20-01_BMP_VRIT_US','Stormwater',
   to_date('09-15-2019 08:50','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-01','St20-01_BMP_SVS_US','Stormwater',
   to_date('09-15-2019 09:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-01','St20-01_BMP_WTBB_US','Stormwater',
   to_date('09-15-2019 09:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-01','St20-01_BMP_VRBB_US','Stormwater',
   to_date('09-15-2019 10:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-01','St20-01_BMP_ETW_US','Stormwater',
   to_date('09-15-2019 11:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-01','St20-01_BMP_QRIB_US','Stormwater',
   to_date('09-15-2019 11:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-01','St20-01_BMP_SVS_DS','Stormwater',
   to_date('09-15-2019 11:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-01','St20-01_BMP_ETW_DS','Stormwater',
   to_date('09-15-2019 12:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-01','St20-01_West_OF1','Stormwater',
   to_date('09-15-2019 12:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-01','St20-01_North_OF1','Stormwater',
   to_date('09-15-2019 12:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-01','St20-01_East_OF1','Stormwater',
   to_date('09-15-2019 13:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-01','St20-01_East_OF2','Stormwater',
   to_date('09-15-2019 13:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-01','St20-01_Stream','Stormwater',
   to_date('09-15-2019 13:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-02','St20-02_blank','Blank',
   to_date('11-04-2019 09:50','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-02','St20-02_BMP_NTIB_US','Stormwater',
   to_date('11-04-2019 08:10','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-02','St20-02_BMP_VRIT_US','Stormwater',
   to_date('11-04-2019 08:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-02','St20-02_BMP_SVS_US','Stormwater',
   to_date('11-04-2019 08:50','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-02','St20-02_BMP_WTBB_US','Stormwater',
   to_date('11-04-2019 09:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-02','St20-02_BMP_WTBB_US_dup','Stormwater',
   to_date('11-04-2019 09:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-02','St20-02_BMP_VRBB_US','Stormwater',
   to_date('11-04-2019 10:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-02','St20-02_BMP_ETW_US','Stormwater',
   to_date('11-04-2019 11:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-02','St20-02_BMP_QRIB_US','Stormwater',
   to_date('11-04-2019 11:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-02','St20-02_BMP_SVS_DS','Stormwater',
   to_date('11-04-2019 11:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-02','St20-02_BMP_ETW_DS','Stormwater',
   to_date('11-04-2019 12:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-02','St20-02_West_OF1','Stormwater',
   to_date('11-04-2019 12:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-02','St20-02_North_OF1','Stormwater',
   to_date('11-04-2019 12:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-02','St20-02_East_OF1','Stormwater',
   to_date('11-04-2019 13:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-02','St20-02_East_OF2','Stormwater',
   to_date('11-04-2019 13:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-02','St20-02_Stream','Stormwater',
   to_date('11-04-2019 13:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-03','St20-03_blank','Blank',
   to_date('02-05-2020 09:50','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-03','St20-03_BMP_NTIB_US','Stormwater',
   to_date('02-05-2020 08:10','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-03','St20-03_BMP_VRIT_US','Stormwater',
   to_date('02-05-2020 08:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-03','St20-03_BMP_SVS_US','Stormwater',
   to_date('02-05-2020 08:50','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-03','St20-03_BMP_WTBB_US','Stormwater',
   to_date('02-05-2020 09:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-03','St20-03_BMP_VRBB_US','Stormwater',
   to_date('02-05-2020 09:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-03','St20-03_BMP_VRBB_US_dup','Stormwater',
   to_date('02-05-2020 10:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-03','St20-03_BMP_ETW_US','Stormwater',
   to_date('02-05-2020 11:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-03','St20-03_BMP_QRIB_US','Stormwater',
   to_date('02-05-2020 11:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-03','St20-03_BMP_SVS_DS','Stormwater',
   to_date('02-05-2020 11:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-03','St20-03_BMP_ETW_DS','Stormwater',
   to_date('02-05-2020 12:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-03','St20-03_West_OF1','Stormwater',
   to_date('02-05-2020 12:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-03','St20-03_North_OF1','Stormwater',
   to_date('02-05-2020 12:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-03','St20-03_East_OF1','Stormwater',
   to_date('02-05-2020 13:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-03','St20-03_East_OF2','Stormwater',
   to_date('02-05-2020 13:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-03','St20-03_Stream','Stormwater',
   to_date('02-05-2020 13:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-04','St20-04_blank','Blank',
   to_date('03-10-2020 09:50','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-04','St20-04_BMP_NTIB_US','Stormwater',
   to_date('03-10-2020 08:10','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-04','St20-04_BMP_VRIT_US','Stormwater',
   to_date('03-10-2020 08:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-04','St20-04_BMP_SVS_US','Stormwater',
   to_date('03-10-2020 08:50','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-04','St20-04_BMP_WTBB_US','Stormwater',
   to_date('03-10-2020 09:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-04','St20-04_BMP_VRBB_US','Stormwater',
   to_date('03-10-2020 09:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-04','St20-04_BMP_ETW_US','Stormwater',
   to_date('03-10-2020 10:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-04','St20-04_BMP_QRIB_US','Stormwater',
   to_date('03-10-2020 11:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-04','St20-04_BMP_QRIB_US_dup','Stormwater',
   to_date('03-10-2020 11:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-04','St20-04_BMP_SVS_DS','Stormwater',
   to_date('03-10-2020 11:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-04','St20-04_BMP_ETW_DS','Stormwater',
   to_date('03-10-2020 12:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-04','St20-04_West_OF1','Stormwater',
   to_date('03-10-2020 12:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-04','St20-04_North_OF1','Stormwater',
   to_date('03-10-2020 12:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-04','St20-04_East_OF1','Stormwater',
   to_date('03-10-2020 13:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-04','St20-04_East_OF2','Stormwater',
   to_date('03-10-2020 13:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2020-04','St20-04_Stream','Stormwater',
   to_date('03-10-2020 13:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-01','St21-01_blank','Blank',
   to_date('11-18-2020 09:50','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-01','St21-01_BMP_NTIB_US','Stormwater',
   to_date('11-18-2020 08:10','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-01','St21-01_BMP_VRIT_US','Stormwater',
   to_date('11-18-2020 08:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-01','St21-01_BMP_SVS_US','Stormwater',
   to_date('11-18-2020 08:50','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-01','St21-01_BMP_WTBB_US','Stormwater',
   to_date('11-18-2020 09:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-01','St21-01_BMP_VRBB_US','Stormwater',
   to_date('11-18-2020 09:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-01','St21-01_BMP_ETW_US','Stormwater',
   to_date('11-18-2020 10:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-01','St21-01_BMP_QRIB_US','Stormwater',
   to_date('11-18-2020 11:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-01','St21-01_BMP_SVS_DS','Stormwater',
   to_date('11-18-2020 11:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-01','St21-01_BMP_ETW_DS','Stormwater',
   to_date('11-18-2020 11:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-01','St21-01_West_OF1','Stormwater',
   to_date('11-18-2020 12:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-01','St21-01_West_OF1_dup','Stormwater',
   to_date('11-18-2020 12:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-01','St21-01_North_OF1','Stormwater',
   to_date('11-18-2020 12:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-01','St21-01_East_OF1','Stormwater',
   to_date('11-18-2020 13:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-01','St21-01_East_OF2','Stormwater',
   to_date('11-18-2020 13:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-01','St21-01_Stream','Stormwater',
   to_date('11-18-2020 13:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-02','St21-02_blank','Blank',
   to_date('12-20-2020 12:50','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-02','St21-02_BMP_NTIB_US','Stormwater',
   to_date('12-20-2020 11:10','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-02','St21-02_BMP_VRIT_US','Stormwater',
   to_date('12-20-2020 11:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-02','St21-02_BMP_SVS_US','Stormwater',
   to_date('12-20-2020 11:50','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-02','St21-02_BMP_WTBB_US','Stormwater',
   to_date('12-20-2020 12:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-02','St21-02_BMP_VRBB_US','Stormwater',
   to_date('12-20-2020 12:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-02','St21-02_BMP_ETW_US','Stormwater',
   to_date('12-20-2020 13:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-02','St21-02_BMP_QRIB_US','Stormwater',
   to_date('12-20-2020 14:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-02','St21-02_BMP_SVS_DS','Stormwater',
   to_date('12-20-2020 14:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-02','St21-02_BMP_ETW_DS','Stormwater',
   to_date('12-20-2020 14:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-02','St21-02_West_OF1','Stormwater',
   to_date('12-20-2020 15:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-02','St21-02_North_OF1','Stormwater',
   to_date('12-20-2020 15:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-02','St21-02_East_OF1','Stormwater',
   to_date('12-20-2020 15:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-02','St21-02_East_OF2','Stormwater',
   to_date('12-20-2020 16:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-02','St21-02_East_OF2_dup','Stormwater',
   to_date('12-20-2020 16:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-02','St21-02_Stream','Stormwater',
   to_date('12-20-2020 16:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-03','St21-03_blank','Blank',
   to_date('01-21-2020 12:50','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-03','St21-03_BMP_NTIB_US','Stormwater',
   to_date('01-21-2020 11:10','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-03','St21-03_BMP_VRIT_US','Stormwater',
   to_date('01-21-2020 11:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-03','St21-03_BMP_SVS_US','Stormwater',
   to_date('01-21-2020 11:50','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-03','St21-03_BMP_WTBB_US','Stormwater',
   to_date('01-21-2020 12:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-03','St21-03_BMP_VRBB_US','Stormwater',
   to_date('01-21-2020 12:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-03','St21-03_BMP_ETW_US','Stormwater',
   to_date('01-21-2020 13:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-03','St21-03_BMP_QRIB_US','Stormwater',
   to_date('01-21-2020 14:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-03','St21-03_BMP_SVS_DS','Stormwater',
   to_date('01-21-2020 14:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-03','St21-03_BMP_ETW_DS','Stormwater',
   to_date('01-21-2020 14:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-03','St21-03_West_OF1','Stormwater',
   to_date('01-21-2020 15:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-03','St21-03_North_OF1','Stormwater',
   to_date('01-21-2020 15:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-03','St21-03_East_OF1','Stormwater',
   to_date('01-21-2020 15:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-03','St21-03_East_OF1_dup','Stormwater',
   to_date('01-21-2020 16:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-03','St21-03_East_OF2','Stormwater',
   to_date('01-21-2020 16:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-03','St21-03_Stream','Stormwater',
   to_date('01-21-2020 16:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-04','St21-04_blank','Blank',
   to_date('02-09-2021 09:50','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-04','St21-04_BMP_NTIB_US','Stormwater',
   to_date('02-09-2021 08:10','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-04','St21-04_BMP_NTIB_US_dup','Stormwater',
   to_date('02-09-2021 08:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-04','St21-04_BMP_VRIT_US','Stormwater',
   to_date('02-09-2021 08:50','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-04','St21-04_BMP_SVS_US','Stormwater',
   to_date('02-09-2021 09:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-04','St21-04_BMP_WTBB_US','Stormwater',
   to_date('02-09-2021 09:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-04','St21-04_BMP_VRBB_US','Stormwater',
   to_date('02-09-2021 10:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-04','St21-04_BMP_ETW_US','Stormwater',
   to_date('02-09-2021 11:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-04','St21-04_BMP_QRIB_US','Stormwater',
   to_date('02-09-2021 11:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-04','St21-04_BMP_SVS_DS','Stormwater',
   to_date('02-09-2021 11:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-04','St21-04_BMP_ETW_DS','Stormwater',
   to_date('02-09-2021 12:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-04','St21-04_West_OF1','Stormwater',
   to_date('02-09-2021 12:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-04','St21-04_North_OF1','Stormwater',
   to_date('02-09-2021 12:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-04','St21-04_East_OF1','Stormwater',
   to_date('02-09-2021 13:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-04','St21-04_East_OF2','Stormwater',
   to_date('02-09-2021 13:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2021-04','St21-04_Stream','Stormwater',
   to_date('02-09-2021 13:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-01','St22-01_blank','Blank',
   to_date('09-19-2021 09:50','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-01','St22-01_BMP_NTIB_US','Stormwater',
   to_date('09-19-2021 08:10','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-01','St22-01_BMP_VRIT_US','Stormwater',
   to_date('09-19-2021 08:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-01','St22-01_BMP_SVS_US','Stormwater',
   to_date('09-19-2021 08:50','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-01','St22-01_BMP_WTBB_US','Stormwater',
   to_date('09-19-2021 09:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-01','St22-01_BMP_WTBB_US_dup','Stormwater',
   to_date('09-19-2021 09:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-01','St22-01_BMP_VRBB_US','Stormwater',
   to_date('09-19-2021 10:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-01','St22-01_BMP_ETW_US','Stormwater',
   to_date('09-19-2021 11:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-01','St22-01_BMP_QRIB_US','Stormwater',
   to_date('09-19-2021 11:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-01','St22-01_BMP_SVS_DS','Stormwater',
   to_date('09-19-2021 11:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-01','St22-01_BMP_ETW_DS','Stormwater',
   to_date('09-19-2021 12:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-01','St22-01_West_OF1','Stormwater',
   to_date('09-19-2021 12:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-01','St22-01_North_OF1','Stormwater',
   to_date('09-19-2021 12:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-01','St22-01_East_OF1','Stormwater',
   to_date('09-19-2021 13:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-01','St22-01_East_OF2','Stormwater',
   to_date('09-19-2021 13:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-01','St22-01_Stream','Stormwater',
   to_date('09-19-2021 13:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-02','St22-02_blank','Blank',
   to_date('11-15-2021 09:50','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-02','St22-02_BMP_NTIB_US','Stormwater',
   to_date('11-15-2021 08:10','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-02','St22-02_BMP_NTIB_US_dup','Stormwater',
   to_date('11-15-2021 08:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-02','St22-02_BMP_VRIT_US','Stormwater',
   to_date('11-15-2021 08:50','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-02','St22-02_BMP_SVS_US','Stormwater',
   to_date('11-15-2021 09:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-02','St22-02_BMP_WTBB_US','Stormwater',
   to_date('11-15-2021 09:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-02','St22-02_BMP_VRBB_US','Stormwater',
   to_date('11-15-2021 10:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-02','St22-02_BMP_ETW_US','Stormwater',
   to_date('11-15-2021 11:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-02','St22-02_BMP_QRIB_US','Stormwater',
   to_date('11-15-2021 11:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-02','St22-02_BMP_SVS_DS','Stormwater',
   to_date('11-15-2021 11:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-02','St22-02_BMP_ETW_DS','Stormwater',
   to_date('11-15-2021 12:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-02','St22-02_West_OF1','Stormwater',
   to_date('11-15-2021 12:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-02','St22-02_North_OF1','Stormwater',
   to_date('11-15-2021 12:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-02','St22-02_East_OF1','Stormwater',
   to_date('11-15-2021 13:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-02','St22-02_East_OF2','Stormwater',
   to_date('11-15-2021 13:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-02','St22-02_Stream','Stormwater',
   to_date('11-15-2021 13:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-03','St22-03_blank','Blank',
   to_date('11-26-2021 09:50','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-03','St22-03_BMP_NTIB_US','Stormwater',
   to_date('11-26-2021 08:10','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-03','St22-03_BMP_VRIT_US','Stormwater',
   to_date('11-26-2021 08:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-03','St22-03_BMP_SVS_US','Stormwater',
   to_date('11-26-2021 08:50','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-03','St22-03_BMP_WTBB_US','Stormwater',
   to_date('11-26-2021 09:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-03','St22-03_BMP_VRBB_US','Stormwater',
   to_date('11-26-2021 09:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-03','St22-03_BMP_ETW_US','Stormwater',
   to_date('11-26-2021 10:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-03','St22-03_BMP_QRIB_US','Stormwater',
   to_date('11-26-2021 11:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-03','St22-03_BMP_QRIB_US_dup','Stormwater',
   to_date('11-26-2021 11:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-03','St22-03_BMP_SVS_DS','Stormwater',
   to_date('11-26-2021 11:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-03','St22-03_BMP_ETW_DS','Stormwater',
   to_date('11-26-2021 12:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-03','St22-03_West_OF1','Stormwater',
   to_date('11-26-2021 12:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-03','St22-03_North_OF1','Stormwater',
   to_date('11-26-2021 12:40','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-03','St22-03_East_OF1','Stormwater',
   to_date('11-26-2021 13:00','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-03','St22-03_East_OF2','Stormwater',
   to_date('11-26-2021 13:20','mm-dd-yyyy hh24:mi'));

insert into Sample
values
('2022-03','St22-03_Stream','Stormwater',
   to_date('11-26-2021 13:40','mm-dd-yyyy hh24:mi'));
